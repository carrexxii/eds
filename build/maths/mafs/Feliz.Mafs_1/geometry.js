...
import { Vec2_$ctor_7B00E9A0, Angle_get_toRad, Angle, Angle_$reflection, Vec2__get_y, Vec2__get_x, Vec2_$ctor_52AF8430, Vec2__get_array, vec, Vec2_$reflection } from "./maths.js";
...
export function Point_Props_get_Default() {
    return new Point_Props(vec(0, 0), Theme.foreground, 1, (p) => p, defaultOf());
}
