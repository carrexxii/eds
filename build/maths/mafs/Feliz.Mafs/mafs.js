...
export function preserveAR(preserveAR_1, props) {
    return new Props(props.width, props.height, props.pan, props.zoom, props.viewBox, preserveAR_1, props.ssr, props.onClick);
}
