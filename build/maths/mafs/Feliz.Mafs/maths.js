...
export function Angle_get_toRad() {
    return (_arg) => ((_arg.tag === 1) ? _arg.fields[0] : (_arg.fields[0] / (2 * 3.141592653589793)));
}
...
export function Vec2__rotate_18D0E04C(this$, angle) {
    let tupledArg;
    return Vec2_$ctor_52AF8430((tupledArg = ((angle.tag === 1) ? [Vec2__get_array(this$), angle.fields[0]] : [Vec2__get_array(this$), angle.fields[0] / (2 * 3.141592653589793)]), vec_2.rotate(tupledArg[0], tupledArg[1])));
}

export function Vec2__rotateAbout(this$, v, angle) {
    let tupledArg;
    return Vec2_$ctor_52AF8430((tupledArg = ((angle.tag === 1) ? [Vec2__get_array(this$), Vec2__get_array(v), angle.fields[0]] : [Vec2__get_array(this$), Vec2__get_array(v), angle.fields[0] / (2 * 3.141592653589793)]), vec_2.rotateAbout(tupledArg[0], tupledArg[1], tupledArg[2])));
}
